...
function FinderIcon({ className }: { className?: string }) {
  return (
    <svg height="800px" width="800px" version="1.1" id="Capa_1"
      viewBox="0 0 279.121 279.121" className={className}>
      <g>
        <path d="M241.512,21.047h-96.208c-0.017,0-0.033,0-0.05,0H37.609C16.872,21.047,0,37.918,0,58.656v161.809
        ...
        <path d="M194.129,67.377c-4.142,0-7.5,3.357-7.5,7.5v33.972c0,4.143,3.358,7.5,7.5,7.5s7.5-3.357,7.5-7.5
		V74.877C201.629,70.734,198.271,67.377,194.129,67.377z"/>
        <path d="M65.379,116.349c4.142,0,7.5-3.357,7.5-7.5V74.877c0-4.143-3.358-7.5-7.5-7.5s-7.5,3.357-7.5,7.5
