...
function TerminalRow({
  ...
  return (
    <div>
      ...
      >
        <span className={cn('text-xs font-medium text-muted-foreground hover:text-foreground truncate max-w-[180px] flex items-center gap-1', isExpanded && 'text-foreground')}>
          {collapsible && (
            <ChevronDown
              className={cn(
