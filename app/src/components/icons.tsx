...
export function TerminalIcon2({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className}>
      <path
        fillRule="evenodd"
...
export function GithubDrafPrIcon({ className }: { className?: string }) {
  return (
    <svg
      focusable="false"
...
export function SessionStatusIcon({
  ...
  if (status === 'ended' && !ended) return null
    ...
    return (
      <>
        ...
        {status === 'permission_needed' && (
          <AlertTriangle
            className={cn(className, 'shrink-0 text-yellow-500 animate-pulse')}
          />
        )}
      </>
    )
